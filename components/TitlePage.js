...
const TitleMenu = ({ title = "", imageSrc = "", description = "", imageClass = "" }) => {
    return <div className="w-full bg-blue-secondary h-24 sm:h-36 rounded-tl-full flex items-center ">
        {/* <img src={imageSrc} className={imageClass ? imageClass : `h-20 sm:h-24`} /> */}
        <div className="flex flex-col ml-24">
            <h1 className="text-xl sm:text-3xl text-blue-primary">{title}</h1>
